...
helper_string_pt_br = {
    ...
    "comment_success": "[Comentário enviado] Se você deseja editar seu comentário, basta modificar a mensagem que você acabou de enviar.",
